...
import mulitplePlatform from "/assets/images/illustration-multiple-platforms.webp";
      ...
      <main className="p-4 font-dmSans pt-16 mb-4 md:grid max-w-[1050px] gap-6 w-full mx-auto flex flex-col md:grid-cols-[240px_1fr_1fr] lg:grid-cols-[240px_1fr_1fr_240px] lg:grid_rows[1fr_1fr] ">
        <article className="bg-purple_500 rounded-xl p-6 py-8 text-center md:col-start-2 md:col-end-5 md:col-span-2 lg:row-start-1 lg:row-end-2 lg:col-end-4 ">
          <h2 className="text-white_100 text-[2.5rem] mb-5 font-semibold leading-[1.2]">
            Social Media <span className="text-yellow_500">10x</span><br/>
        ...
        <article className="bg-yellow_500 px-4 pt-4 rounded-xl md:col-span-2 md:col-start-4 md:col-end-4 md:w-[260px] lg:row-start-2 lg:row-end-3 lg:col-start-3 lg:col-end-4 lg:w-full relative overflow-hidden">
        ...
        <article className="bg-purple_100 p-6 py-8 rounded-xl flex flex-col items-center gap-6 text-center lg:col-start-4 lg:row-start-1 lg:row-end-3 lg:text-left relative overflow-hidden">
          <h2 className="text-xl mb-5 title ">Schedule to social media.</h2>
          <div className="relative lg:w-[280px] lg:h-[230px] ">
          <img src={schedulePosts} alt="Schedule to social media" className="lg:absolute  lg:-right-[2.7rem] lg:-top-8" />
          </div>
        ...
        <article className="bg-purple_500 p-8 pt-8 py-6 rounded-xl text-center flex flex-col items-center col-start-2 col-end-5 justify-center lg:flex-row lg:col-start-3 lg:col-end-5 lg:text-left ">
